...
namespace ASCOM.INDIGO {
  ...
  //
  // The Guid attribute sets the CLSID for ASCOM.INDIGO.Rate
  // The ClassInterface/None addribute prevents an empty interface called
  // _Rate from being created and used as the [default] interface
  //
  [Guid("6fcdacb6-810a-49f9-b568-6dd7520eecc4")]
  ...
  // this polymorphism. 
  //
  // The Guid attribute sets the CLSID for ASCOM.INDIGO.AxisRates
  // The ClassInterface/None addribute prevents an empty interface called
  // _AxisRates from being created and used as the [default] interface
  //
  [Guid("4e5f943f-97f5-434e-a063-b995342ea5e5")]
  [ClassInterface(ClassInterfaceType.None)]
  [ComVisible(true)]
  ...
  // this polymorphism. 
  //
  // The Guid attribute sets the CLSID for ASCOM.INDIGO.TrackingRates
  // The ClassInterface/None addribute prevents an empty interface called
  ...
  //
  [Guid("c08e4f82-02f5-4faf-ab0f-85e3a53ec375")]
  [ClassInterface(ClassInterfaceType.None)]
  [ComVisible(true)]
